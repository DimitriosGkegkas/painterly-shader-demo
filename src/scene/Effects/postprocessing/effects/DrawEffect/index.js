...
class DrawEffect extends Effect {
  constructor() {
    const noiseTexture = new TextureLoader().load('/assets/textures/noise/noise.png')
    noiseTexture.wrapS = noiseTexture.wrapT = RepeatWrapping

    const noiseTexture2 = new TextureLoader().load('/assets/textures/paper/sketch.jpg')
    noiseTexture2.wrapS = noiseTexture2.wrapT = RepeatWrapping

    const paperTexture = new TextureLoader().load('/assets/textures/paper/Craft_Light.jpg')
